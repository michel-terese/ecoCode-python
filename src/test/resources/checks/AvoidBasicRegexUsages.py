...
if re.search(r'^abc\.txt', string):   # Noncompliant {{Use string.startswith instead of re.search}}
...
if re.search('^abc', string):    # Noncompliant {{Use string.startswith instead of re.search}}
    print('string starts with abc')
